...
export const GlowingStarsDescription = ({
  ...
  return <p className={cn("text-base text-gray-600 max-w-[16rem]", className)}>
      {children}
    </p>;
};
export const GlowingStarsTitle = ({
  ...
  return <h2 className={cn("font-bold text-2xl text-sheraa-dark", className)}>
      {children}
    </h2>;
};
...
const Star = ({
  ...
  return <motion.div key={delay} initial={{
    scale: 1
  }} animate={{
