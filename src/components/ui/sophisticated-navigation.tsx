...
const navigationItems: NavigationItem[] = [
  ...
  { 
    ...
    icon: Users,
    subItems: [
      { name: 'Our Story', path: '/about', description: 'Learn about our mission' },
      { name: 'Leadership', path: '/about/leadership', description: 'Meet our executive team' },
      { name: 'Board', path: '/about/board', description: 'Our advisory board' }
    ]
  },
  { 
    name: 'Programs', 
    ...
    icon: BookOpen,
    subItems: [
      { name: 'S3 Incubator', path: '/programs/s3-incubator', description: 'Our flagship program' },
      { name: 'Startup Dojo', path: '/programs/startup-dojo', description: 'Youth entrepreneurship' },
      { name: 'Access Challenge', path: '/programs/access-sharjah-challenge', description: 'Global competition' }
    ]
  },
  { 
    name: 'Events', 
    ...
    icon: Calendar,
    subItems: [
      { name: 'Upcoming', path: '/events/upcoming', description: 'Join our next events' },
      { name: 'Past Events', path: '/events/past', description: 'Event highlights' }
    ]
  },
          ...
          <div className="flex items-center justify-between px-8 relative z-10">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              >
                ...
                <div className="text-xs text-gray-500 -mt-1">Entrepreneurship Hub</div>
              </motion.div>
            </Link>
                  ...
                  <div key={item.name} className="relative">
                    ...
                    >
                      <Link
                        ...
                        className={cn(
                          "flex items-center space-x-2 px-4 py-2.5 rounded-xl font-medium transition-all duration-300 group relative overflow-hidden",
                          isActive
                    ...
                    <AnimatePresence>
                      {item.subItems && activeDropdown === item.name && (
                        <motion.div
                          ...
                          className="absolute top-full mt-2 left-1/2 transform -translate-x-1/2 bg-white/95 backdrop-blur-3xl border border-gray-200/50 shadow-2xl rounded-2xl overflow-hidden min-w-80 z-50"
