...
const QuoteSection = () => {
  ...
  return <ParallaxSection direction="up" scrollMultiplier={0} // Disable parallax on mobile
  spring={false}>
      <section ref={containerRef} className="relative py-8 md:py-32 overflow-visible px-3 md:px-0" style={{
      ...
      display: 'block'
        ...
        <div className="container relative z-10">
          <motion.div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm p-4 md:p-12 rounded-xl border border-sheraa-primary/20 shadow-lg relative" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          stiffness: 70
            ...
            stiffness: 100
              ...
              {!isMobile && sparklePositions.map((sparkle, index) => <motion.div key={index} className="absolute rounded-full bg-sheraa-primary" style={{
              top: `${sparkle.y}%`,
              left: `${sparkle.x}%`,
            ...
            <blockquote>
              ...
              delay: 0.2,
              duration: 0.8
            }} className="text-sm font-plus-jakarta leading-relaxed mb-3 md:mb-6 text-zinc-700 font-bold md:text-3xl">
