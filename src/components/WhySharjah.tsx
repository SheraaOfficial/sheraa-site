      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          duration: 0.5
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              delay: index * 0.1
                  ...
                  <div className="flex-shrink-0">
                    <svg className="w-6 h-6 text-sheraa-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Button asChild className="mt-12 bg-sheraa-primary hover:bg-sheraa-primary/90">
          ...
          delay: 0.2
            ...
            <div className="relative p-12">              
              ...
              <motion.div className="absolute -bottom-6 -right-6 w-32 h-32 bg-sheraa-primary/10 rounded-full" animate={{
              scale: [1, 1.2, 1],
              opacity: [0.3, 0.6, 0.3]
            }} transition={{
              duration: 3,
              ...
              <motion.div className="absolute -top-6 -left-6 w-24 h-24 bg-sheraa-secondary/10 rounded-full" animate={{
              scale: [1, 1.1, 1],
              opacity: [0.2, 0.4, 0.2]
            }} transition={{
              duration: 2.5,
