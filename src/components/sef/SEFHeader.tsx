  ...
  return (
    <div className="space-y-8">
      <motion.div 
        ...
        className="inline-flex items-center bg-white/90 text-sheraa-sef-primary rounded-full shadow-xl px-0 py-0"
      >
        <Sparkles className="relative mr-1" colors={["#9b87f5", "#D6BCFA"]} count={5}>
      ...
      >
        ...
        <Button 
          ...
          size="lg" 
          variant="outline" 
          className="bg-white/15 text-white border-white/40 hover:bg-white/25 backdrop-blur-xl hover:border-white/60 transition-all duration-300"
        >
