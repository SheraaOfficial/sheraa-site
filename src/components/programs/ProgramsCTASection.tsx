...
import { ArrowRight, Users, FileText, Phone, Clock, DollarSign, CheckCircle } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <h3 className="font-bold mb-2 text-lg">Get $30k Funding</h3>
          ...
          >
            ...
            <p className="text-sm text-white/80">One-on-one consultation with our program advisors</p>
          </Link>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-white/80">Help throughout the process</div>
            </div>
          </div>
        </motion.div>
      </div>
