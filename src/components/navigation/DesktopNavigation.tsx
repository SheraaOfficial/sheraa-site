  ...
  return <div className="">
      <NavigationMenu className="mx-6">
        <NavigationMenuList>
          ...
          <NavigationMenuItem>
            <Link to="/eligibility" className={navigationMenuTriggerStyle()} aria-label="Apply to Sheraa programs">
          ...
          <NavigationMenuItem>
            <Link to={sefLink.href} className="group flex items-center gap-2 relative px-4 py-2 mx-1 rounded-md text-sm font-medium" aria-label={sefLink.description || sefLink.title}>
      ...
      <div className="flex items-center gap-2">
        {/* Theme toggle button */}
        <Button variant="ghost" size="icon" onClick={toggleTheme} className="text-gray-600 dark:text-gray-300 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white rounded-full" aria-label={theme === 'dark' ? 'Switch to light theme' : 'Switch to dark theme'}>
