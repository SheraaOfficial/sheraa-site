    ...
    <section className="py-8 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
          ...
          >
            <div className="bg-white rounded-xl p-4 md:p-6 border border-gray-200 hover:border-sheraa-primary/20 transition-all">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <div className="bg-white rounded-xl p-4 md:p-6 border border-gray-200 hover:border-sheraa-orange/20 transition-all">
              <div className="flex items-start gap-4">
