  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-sheraa-primary/10 text-sheraa-primary text-sm font-semibold mb-4 tracking-wide">
        ...
        >
          {stats.map((stat, index) => (
            <motion.div key={index} variants={itemVariants}>
              <Card className="relative bg-white border shadow-md hover:shadow-lg transition-all duration-300">
                <CardContent className="p-8 text-center">
                  <stat.icon className="w-8 h-8 mx-auto mb-6 text-sheraa-primary" />
                  <div className="text-6xl font-black text-sheraa-primary mb-6 tracking-tight">
                  ...
                  <div className="flex items-center justify-center text-sm font-medium text-green-600 bg-green-50 px-3 py-1.5 rounded-full">
