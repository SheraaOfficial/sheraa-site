...
const ImpactNumbers = () => {
  ...
  return <ParallaxSection direction="up" scrollMultiplier={0} // Disable parallax on mobile for better performance
  spring={false}>
      <section ref={sectionRef} style={{
      minHeight: isMobile ? '600px' : 'auto',
      visibility: 'visible',
      display: 'block'
    }} className="md:py-24 relative overflow-visible py-[15px]">
        {!isMobile && <ImpactBackground springScroll={springScroll} />}
        
        <div className="container mx-auto px-3 md:px-6 relative z-10">
          <motion.div className="text-center mb-4 md:mb-16 max-w-3xl mx-auto" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          stiffness: 50
            ...
            <motion.p className="text-gray-600 leading-relaxed text-sm md:text-lg px-2" initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} viewport={{
          ...
          <motion.div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-1 md:gap-3 relative z-10 max-w-7xl mx-auto" style={{
          x: isMobile ? 0 : shift
        }}>
          ...
          <motion.div className="mt-6 md:mt-16 text-center" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          stiffness: 70
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button asChild variant="shimmer" size={isMobile ? "default" : "lg"} className="min-w-[180px] sm:min-w-[200px] group">
                <a href="/lovable-uploads/sheraa-impact-report-2024.pdf" target="_blank" download="Sheraa-Impact-Report-2024.pdf">
