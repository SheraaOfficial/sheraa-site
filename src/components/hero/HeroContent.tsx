...
export function HeroContent() {
  ...
  return <div className="flex flex-col justify-center items-center w-[90%] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto mx-auto">
      ...
      <motion.div className="mb-4 sm:mb-6" initial={badgeVariants.initial} animate={badgeVariants.animate} transition={badgeVariants.transition}>
        <Badge variant="gradient-warm" size={isMobile ? "default" : "lg"} animation="float" className="py-1 sm:py-1.5 px-3 sm:px-4 text-xs sm:text-sm">
      ...
      <motion.h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl text-center w-full justify-center items-center flex-col flex whitespace-pre leading-tight font-bold tracking-tight space-y-1 md:space-y-3" initial={titleVariants.initial} animate={titleVariants.animate} transition={titleVariants.transition}>
        <span className="text-5xl">Making your </span>
        <LayoutGroup>
          <motion.span layout className="flex whitespace-pre">
            ...
            damping: 30,
            stiffness: 400
          }} className="flex whitespace-pre text-5xl font-bold">
              startup{" "}
            </motion.span>
