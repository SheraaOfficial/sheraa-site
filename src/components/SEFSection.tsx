      ...
      <section ref={sectionRef} className="relative overflow-hidden" id="sef-section">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center lg:items-start">
            ...
            <div className="lg:col-span-7 text-white relative my-0 py-0 px-[22px]">
              ...
              {isInView && <Suspense fallback={<LoadingFallback />}>
                  <SEFDescription isInView={isInView} />
                </Suspense>}
              
              {isInView && hasRevealed && <Suspense fallback={<LoadingFallback />}>
