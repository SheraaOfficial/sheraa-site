...
const SEFSection = () => {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
            ...
            >
              <div className="inline-block bg-sheraa-secondary/10 px-4 py-1 rounded-full text-sheraa-secondary text-sm font-medium mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                ...
                >
                  <Users className="w-8 h-8 text-sheraa-primary mb-4" />
                  <div className="text-4xl font-black mb-2 text-sheraa-dark">5,000+</div>
                ...
                <motion.div 
                  ...
                  className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100"
                >
                  <Star className="w-8 h-8 text-sheraa-primary mb-4" />
                  <div className="text-4xl font-black mb-2 text-sheraa-dark">100+</div>
                ...
                <motion.div 
                  ...
                  className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100"
                >
                  <Globe className="w-8 h-8 text-sheraa-primary mb-4" />
                  <div className="text-4xl font-black mb-2 text-sheraa-dark">50+</div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button 
                  asChild 
                  variant="outline"
                  className="border-sheraa-primary text-sheraa-primary hover:bg-sheraa-primary/5"
                >
          ...
          <div className="lg:col-span-2">
            <motion.div 
              ...
              className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100"
            >
              <h3 className="text-2xl font-bold mb-6 text-sheraa-dark">SEF 2025</h3>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <Calendar className="w-5 h-5 text-sheraa-primary mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <MapPin className="w-5 h-5 text-sheraa-primary mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Star className="w-5 h-5 text-sheraa-primary mt-1" />
                  <div>
              ...
              <Button 
                asChild 
                className="w-full mt-8 bg-sheraa-primary hover:bg-sheraa-primary/90"
              >
      ...
      {/* Decorative elements that connect to WhySharjah section */}
