...
const MembershipSection = () => {
  ...
  return <div className="py-16 bg-sheraa-light">
      <div className="container mx-auto px-4 md:px-6">
        ...
        duration: 0.5
          ...
          <Badge variant="gradient-warm" animation="shimmer" className="mb-3 bg-sheraa-primary my-0 py-0 px-[24px] mx-0">Join Our Community</Badge>
        ...
        <div className="mb-12">
          <Card className="border-0 shadow-xl bg-white overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-sheraa-primary to-sheraa-secondary text-white text-center py-8 bg-sheraa-orange">
            ...
            <CardContent className="p-6 md:p-8 px-0 py-[25px] my-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {benefits.map((benefit, index) => <motion.div key={benefit.category} initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                delay: index * 0.1
                    ...
                    <ul className="space-y-2">
                      {benefit.items.map((item, i) => <li key={i} className="flex items-start gap-2">
