          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 min-h-[calc(100vh-12rem)]">
            ...
            >
              ...
              <div className="space-y-4 mt-8">
                {[
                  { icon: Users, title: "Build Your Network", desc: "Connect with like-minded entrepreneurs and industry experts" },
                  { icon: Target, title: "Access Programs", desc: "Join incubators, challenges, and growth programs" },
                  { icon: Award, title: "Share Your Story", desc: "Showcase your journey and inspire others" },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
