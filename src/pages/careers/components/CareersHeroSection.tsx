...
import { Rocket, Users, Target, ArrowRight, Building, MapPin, Heart, Sparkles } from 'lucide-react';
const CareersHeroSection: React.FC = () => {
  return <section className="relative py-24 md:py-32 bg-gradient-to-br from-sheraa-primary/5 via-white to-sheraa-secondary/5 dark:from-sheraa-dark/50 dark:to-sheraa-dark/30 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-96 h-96 bg-sheraa-primary/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 left-20 w-64 h-64 bg-sheraa-secondary/10 rounded-full blur-2xl animate-pulse" style={{
        animationDelay: '1s'
      }} />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        duration: 0.7
          ...
          delay: 0.2
            ...
            <span className="text-sm font-bold bg-gradient-to-r from-sheraa-primary to-sheraa-secondary bg-clip-text text-slate-900">
        ...
        delay: 0.3
          ...
          icon: Building
        }].map((stat, idx) => <motion.div key={idx} whileHover={{
          scale: 1.05
        ...
        delay: 0.5
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["SRTIP Headquarters", "American University of Sharjah", "University of Sharjah"].map((location, idx) => <Badge key={idx} variant="outline" className="px-4 py-2 text-sm">
