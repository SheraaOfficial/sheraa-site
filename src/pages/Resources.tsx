          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-sheraa-primary via-sheraa-teal to-sheraa-primary bg-clip-text text-transparent">
                Your Entrepreneurial Toolkit<br />Knowledge & Support
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Building a successful venture requires more than just a great idea. Access essential resources, expert guidance, and timely insights to navigate the complexities of the startup journey.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild variant="outline" size="lg" className="border-sheraa-primary/30 text-sheraa-primary hover:bg-sheraa-primary/10">
                  <Link to="/resources/advisory">Get Expert Advice</Link>
                </Button>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our resources are curated based on the real-world needs of founders within our ecosystem, offering actionable advice specific to the Sharjah and UAE context.
              </p>
            </motion.div>
        ...
        <section className="py-20 bg-gray-50 dark:bg-sheraa-dark/30">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Get started with these highly-rated resources that have helped thousands of entrepreneurs build better businesses.
              </p>
            </motion.div>
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white dark:bg-sheraa-dark">
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">{resource.description}</p>
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Our team is here to help you find the right resources or connect you with the right experts for your specific challenges.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
