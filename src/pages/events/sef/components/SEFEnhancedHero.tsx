  ...
  return (
    <section className="relative min-h-[100vh] w-full flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 overflow-hidden">
        {Array.from({
        length: 30
      }).map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-white rounded-full" initial={{
        x: `${Math.random() * 100}%`,
        y: `${Math.random() * 100}%`,
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-20">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="space-y-4 mb-10">
            ...
            <motion.p custom={2} initial="initial" animate="animate" variants={textAnimation} className="text-xl md:text-2xl text-white/70 max-w-3xl mx-auto">
