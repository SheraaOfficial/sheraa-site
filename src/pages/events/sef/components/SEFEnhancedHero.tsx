  ...
  return (
    <section className="relative min-h-[100vh] w-full flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?q=80&w=2000" alt="SEF Event" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-20">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Sparkles>
              <span className="inline-flex items-center bg-white/10 backdrop-blur-md text-sheraa-sef-primary rounded-full px-4 py-2 text-sm font-medium border border-white/20">
          ...
          <div className="space-y-4 mb-10">
            <motion.h1 
              ...
              className="text-5xl font-extrabold uppercase tracking-tighter text-white drop-shadow-lg leading-tight md:text-8xl"
            >
          ...
          >
            <GradientButton 
              ...
              variant="shimmer" 
              size="lg" 
              className="group shadow-xl hover:shadow-[0_5px_30px_rgba(155,135,245,0.4)] font-bold bg-sheraa-sef-primary hover:bg-sheraa-sef-primary/90"
            >
            ...
            <Button 
              ...
              size="lg" 
              variant="outline" 
              className="bg-white/10 text-white border-white/30 hover:bg-white/20 backdrop-blur-xl hover:border-white/50 transition-all duration-300 font-medium"
            >
