...
const passes: PassType[] = [{
  ...
  features: [
    'Access to all zones',
    '2-day festival entry',
    'Access to workshops',
    'Digital program guide',
    'SEF mobile app access',
  ...
  features: [
    'All Standard Pass features, plus:',
    'VIP lounge access',
  ...
  features: [
    'All Premium Pass features, plus:',
  ...
  return (
    ...
    >
      ...
      <div className={`${pass.color} px-6 py-8 text-white`}>
        ...
        {pass.description && (
          <p className="text-white/80 text-sm mt-1">{pass.description}</p>
        )}
      ...
      <div className="p-6 bg-white dark:bg-gray-800">
        ...
        {hasMoreFeatures && (
          <button 
            ...
            className="flex items-center text-sm text-blue-500 hover:text-blue-700 mt-2 mb-2"
          >
            {showAllFeatures ? (
              <>Show less {<ChevronUp className="h-4 w-4 ml-1" />}</>
            ) : (
              <>Show all features {<ChevronDown className="h-4 w-4 ml-1" />}</>
            )}
          </button>
        )}
        ...
        <div className="mt-4">
          {pass.popular || pass.vip ? (
            ...
            <Button 
              ...
              className={cn(
                "w-full",
                pass.name === "Executive Pass" ? "bg-amber-600 hover:bg-amber-500 text-white" : ""
              )}
              asChild
            >
              <Link to="/events/sef/register">
