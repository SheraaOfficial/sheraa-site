            ...
            <ErrorBoundary FallbackComponent={({ error, resetErrorBoundary }) => (
              ...
              <main>
                <Routes>
                  ...
                  <Route path="/auth/login" element={<Suspense fallback={<SectionLoading />}><LoginPage /></Suspense>} />
                  <Route path="/auth/signup" element={<Suspense fallback={<SectionLoading />}><SignupPage /></Suspense>} />
